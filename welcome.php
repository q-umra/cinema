           ...
           <nav class="navbar navbar-inverse">
               <div class="container-fluid">
                 ...
                 <ul class="nav navbar-nav navbar-right">
                   <li><a href="http://localhost/cs314/bookingMovie/reset-password.php"><span class="glyphicon glyphicon-user" > </span> <?php echo htmlspecialchars($_SESSION["username"]); ?></a></li>
                   <li><a href="http://localhost/cs314/bookingMovie/logout.php"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
                 </ul>
               </div> 
             </nav>  
             </div> 
      ...
      for ($i = 0; $i <= 17; $i++){  
        //to make $row = value that take from table 
         $row = mysqli_fetch_array($result); 
             ...
             echo '<a href="booking.php?id='.$row['movieID'].'"><i class="fas fa-ticket-alt"></i> Book a seat</a>';//to put a button 
             echo '</div>';
             echo '</div>';
             }
